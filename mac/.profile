# .bash_profile would override .profile, such that the latter would 
# not be used. Thus, we will simply not create the former. 

source /usr/local/bin/virtualenvwrapper.sh
export WORKON_HOME=~/.virtualenvs

# to get date hash for image tagging
alias hashtag='bash ~/code/utils/hashtag.sh'
...
# Change prompt: Only show name of current directory.
# http://www.gnu.org/software/bash/manual/bash.html#Controlling-the-Prompt
# http://unix.stackexchange.com/questions/100959/how-can-i-change-my-bash-prompt-to-show-my-working-directory
PS1='\W\$ '

# Adjust the tab title in iTerm2.
# source:
